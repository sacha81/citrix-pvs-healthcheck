...
# 
# This Script is working on PVS 1909 and higher, for 7.7 until 1906 use Citrix-PVS77-Farm-Health-toHTML.ps1
# for older PVS Version (7.6 and below) use the Script here: http://blog.appcloud.ch/citrix-pvs-healthcheck/
#
